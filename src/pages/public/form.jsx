  ...
  return (
    <>
      <div className='w-screen h-full'>
        ...
        {/* Header */}
        <div className='w-full h-auto bg-white py-6 font-medium font-[HinaMincho] shadow-lg my-2 px-20'>
        ...
        <div className='w-auto h-auto mx-20 py-4 px-12'>
          ...
          {/* Dropdown Selection */}
          <div className='mt-8'>
            <span className='text-2xl font-semibold'>What Type of Form?</span>
            <select
