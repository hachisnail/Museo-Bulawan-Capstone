...
const AdminHeader = () => {
  ...
  return (
    <>
      <header className="bg-[#1C1B19] w-screen fixed z-50 text-white h-24 flex-row justify-center items-center drop-shadow-xl shadow-gray-900/50 py-3 pt-5">
          <div className="flex justify-center items-center h-full w-full">
              <div className="h-12 w-full flex justify-between items-center px-3 pr-9">
                  <div className="h-full w-auto flex justify-center items-center gap-x-1.5">
                      <img src="../assets/LOGO.png" alt="Museo Bulawan Logo" className="h-full"></img>
